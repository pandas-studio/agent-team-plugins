...
# ($WORKSPACE/log/$TEAM, $WORKSPACE/state/$TEAM). lib/namespace.sh rejects an
# explicit AGENT_TEAM outside [A-Za-z0-9][A-Za-z0-9._-]* (hard error) and
# sanitizes a tmux-derived name to that set with a loud warning.
detect_team() {
