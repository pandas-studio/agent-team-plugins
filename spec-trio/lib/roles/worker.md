...
- `ask-gemini.sh` — *before* coding, when you're uncertain about external library/API behavior. Don't use it for things you can answer by reading the repo. (Provided by the `dev-trio` plugin on PATH.)
