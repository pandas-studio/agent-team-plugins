...
4. **Calls out unknowns.** If you'd want a Gemini lookup before coding, write `## NEED RESEARCH` followed by the question(s). The harness will fetch and re-invoke the coder with research attached.
...
- <one specific question for Gemini>
```
