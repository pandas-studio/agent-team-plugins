#!/usr/bin/env bash
# common.sh — shared helpers for ralph-{solo,trio,debate,meta}.sh.
#
...
[ -f "$_NAMESPACE_LIB" ] || { echo "ralph: namespace.sh not found at $_NAMESPACE_LIB" >&2; return 1 2>/dev/null || exit 1; }
