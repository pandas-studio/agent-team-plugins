...
# For trio + meta (Codex reviewer + Gemini researcher):
...
4. If codex emits a `## NEED RESEARCH` block: invoke `ask-gemini.sh`, re-run Stage 2 with research context, re-review.
